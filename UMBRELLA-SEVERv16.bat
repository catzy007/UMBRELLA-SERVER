...
:NAMEUMBR
echo nul >%windir%\UMBRPAS.inf
echo nul >%windir%\UMBRPASX.inf
echo %random% >%windir%\umbrdated.inf
...
echo.
echo ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
echo  Enter Correct Command.                                          UMBRELLA-SERVER Control Panel V16.071215
echo ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ 
timeout /t 3 /nobreak > nul
:LOP2
del %windir%\netcon.inf
...
echo.
echo ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ 
echo  Connecting Client...                                                          UMBRELLA-SERVER V16.071215
echo ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ 
echo %date:~4,13% >%windir%\umbrdate.inf
...
goto LINE9
:LINE9
echo %PAS1% >%windir%\UMBRPAS.inf
echo %PAS2% >>%windir%\UMBRPAS.inf
echo %PAS3% >>%windir%\UMBRPAS.inf
echo %PAS4% >>%windir%\UMBRPAS.inf
echo %PAS5% >>%windir%\UMBRPAS.inf
echo %PAS6% >>%windir%\UMBRPAS.inf
echo %PAS7% >>%windir%\UMBRPAS.inf
echo %PAS8% >>%windir%\UMBRPAS.inf
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "A"')do set countPASSCC=%%i
...
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "B"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "C"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "D"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "E"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "F"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "G"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "H"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "I"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "J"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "K"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "L"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "M"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "N"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "O"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "P"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "Q"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "R"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "S"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "T"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "U"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "V"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "W"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "X"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "Y"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "Z"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "1"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "2"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "3"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "4"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "5"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "6"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "7"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "8"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "9"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
if %countPASSCC%==7 goto DTEUNPSD
if %countPASSCC%==8 goto DTEUNPSD
for /f %%i in ('type %windir%\UMBRPAS.inf ^| find /C "0"')do set countPASSCC=%%i
if %countPASSCC%==2 goto DTEUNPSD
if %countPASSCC%==3 goto DTEUNPSD
if %countPASSCC%==4 goto DTEUNPSD
if %countPASSCC%==5 goto DTEUNPSD
...
echo.
echo ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ 
echo  Enter Your Network Name                                                            SYSTEM@REN V16.071215
echo ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
...
goto LOPDC
:LOP2X
Echo  SYSTEM@REN mode only active while server disconnected. . .
...
echo.
echo ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ 
echo  CPAS Command. . .                                                                 SYSTEM@CPAS V16.071215
echo ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
...
echo.
echo ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ 
echo  ERROR Failed To Connect                                         UMBRELLA-SERVER Control Panel V16.071215
echo ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
timeout /t 5 /nobreak > nul
goto LOPDC
:STATUS
...
echo.
echo ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ 
echo  Reconnecting Client...                                                        UMBRELLA-SERVER V16.071215
echo ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
echo  Disconnecting client, Please wait...
netsh wlan stop hostednetwork > nul
...
goto LINE18
:LINE18
echo %PAS1% >%windir%\UMBRPASX.inf
echo %PAS2% >>%windir%\UMBRPASX.inf
echo %PAS3% >>%windir%\UMBRPASX.inf
echo %PAS4% >>%windir%\UMBRPASX.inf
echo %PAS5% >>%windir%\UMBRPASX.inf
echo %PAS6% >>%windir%\UMBRPASX.inf
echo %PAS7% >>%windir%\UMBRPASX.inf
echo %PAS8% >>%windir%\UMBRPASX.inf
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "A"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
if %countPASSCCX%==6 goto DTEUNPSDX
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "B"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "C"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "D"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "E"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "F"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "G"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "H"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "I"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "J"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "K"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "L"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "M"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "N"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "O"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "P"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "Q"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "R"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "S"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "T"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "U"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "V"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "W"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "X"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "Y"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "Z"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "1"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "2"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "3"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "4"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "5"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "6"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "7"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "8"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "9"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
if %countPASSCCX%==7 goto DTEUNPSDX
if %countPASSCCX%==8 goto DTEUNPSDX
for /f %%i in ('type %windir%\UMBRPASX.inf ^| find /C "0"')do set countPASSCCX=%%i
if %countPASSCCX%==2 goto DTEUNPSDX
if %countPASSCCX%==3 goto DTEUNPSDX
if %countPASSCCX%==4 goto DTEUNPSDX
if %countPASSCCX%==5 goto DTEUNPSDX
...
echo  Reconnecting client, please wait...
echo %PAS1%%PAS2%%PAS3%%PAS4%%PAS5%%PAS6%%PAS7%%PAS8% >%windir%\UMBRPAS.inf
echo %PAS1%%PAS2%%PAS3%%PAS4%%PAS5%%PAS6%%PAS7%%PAS8% >%windir%\UMBRPASX.inf
for /f %%N in (%windir%\umbrella.inf) do (
for /f %%M in (%windir%\UMBRPASX.inf) do (
echo Hostname : %%N
echo Password : %%M
netsh wlan set hostednetwork mode=allow ssid=%%N key=%%M > nul
echo %%M >Connect.inf
...
echo.
echo ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ 
echo  ERROR! Core Load Failed!                                                      UMBRELLA-SERVER V16.071215
echo ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ 
timeout /t 5 /nobreak > nul
exit
:ERRORCODE2
...
echo.
echo ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ 
echo  ERROR! Core File Not Found!                                                   UMBRELLA-SERVER V16.071215
echo ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ 
timeout /t 5 /nobreak > nul
exit